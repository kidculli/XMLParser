...
void XMLParser::parse_XML(const string file_name)
{
    ...
    while (getline(XML_file, curr_line)) {
        ...
        switch(curr_state)
        {
            case UNKNOWN : 
                cout << "UNKNOWN\n" ; 
                cout << "content: " << curr_element_content<<endl<<endl; 
                break ;
            ...
            case ELEMENT_OPENING_TAG : 
                ...
                if (root == NULL)
                {
                    ...
                    cout << "Pushed " << root->get_element_name() << " onto element stack" <<endl; 
                ...
                else
                {
                    ...
                    cout << "Pushed " << temp->get_element_name() << " onto element stack" <<endl;
                    print_stack(unclosed_element_stack); 
                    cout <<endl; 
                }
                break ;
            ...
            case ELEMENT_CLOSING_TAG : 
            {
                ...
                cout << "Top of stack: " << unclosed_element_stack.top()->get_element_name() << endl; 
                print_stack(unclosed_element_stack); 
                cout <<endl; 
                break ;
            }
            case SELF_CLOSING_TAG : 
            {
                ...
                cout << "Element name: " << temp->get_element_name() <<endl<<endl; 
                // add to vector
                element_vector.push_back(temp);
                break ;
            }
...
void XMLParser::traverse_element_tree(XMLElement* curr)
{
    ...
    {
//       cout << curr->get_Children 
//	cout << curr_lvl 
//	for i in curr-> get_Children
//	{
//		traverse_tree(i, curr_lvl + 1); 
//	}
